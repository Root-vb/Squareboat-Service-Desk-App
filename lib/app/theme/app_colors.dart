...
class AppColors {
  ...
  static const primaryBlue = Color(0xff3075FD);
  static const primaryIndigo = Color(0xffA3A0BF);
  static const white = Color(0xFFFFFFFF);
  static const green = Color(0xff3FB882);
  static const red = Color(0xffE80C0C);
